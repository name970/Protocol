...
| §2.2/§2.4 SMA audit |Stochastic Matrix Audit over F_p, integer-exactness/range check, commit–reveal challenge derivation | `-` | not implemented|
| §2.3 Aggregation | scaled FP64 summation of verified partial products | `src/lib.rs` | not implemented |
| §2.4 Time-seal (VDF) | delay function + verification | `-` | open / prototype |
